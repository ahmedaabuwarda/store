...
@section('content')
    ...
    <div class="container-fluid mt--8">
            ...
            <div class="col-xl-12">
                <div class="card">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-9 col-md-12 text-center">
                                <input type="text" name="search_input" id="search_input" class="form-control"
                                    placeholder="...ابحث عن وحدات">
                            </div>
                            <div class="col-xl-2 col-md-12 text-right">
                                <a class="btn btn-dark text-white position-relative" data-toggle="modal" data-target="#create_group_modal">
                                    وحدة +
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <!-- Projects table -->
                        <table class="table tablee align-items-center table-flush table-hover" id="group_table">
        ...
        <nav aria-label="..." class="justify-content-center">
            <ul class="pagination justify-content-center">
                ...
                @for ($p = 1; $p <= $pages; $p++)
                    <li class="page-item @if (Request::fullUrl() == URL('/groups?page=' . $p)) active @endif"><a class="page-link"
                            href="{{ URL('/groups?page=' . $p) }}">{{ $p }}</a></li>
                @endfor
                <li class="page-item">
    ...
    <!-- Modal::create group -->
    <div class="modal fade" id="create_group_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <script>
        ...
        function get_groups() {
            $.ajax({
                ...
                success: function(response) {
                    $('#group_table').html('');
                    $('#group_table').append(response.table);
                },
                error: function(response) {
                    Swal.fire(
                        'خطأ',
