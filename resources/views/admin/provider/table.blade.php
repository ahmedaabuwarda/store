...
<tbody>
  ...
  <tr>
    ...
    <td class="display-3 text-center">
      <button class="btn btn-sm btn-primary from_to_pdf_button" data-toggle="tooltip" data-placement="top" title="كشف حساب" data-fromto="{{ $provider->id }}"><i class="fa fa-eye"></i></button>
    </td>
  </tr>
  @php $i++; @endphp
  @endforeach
