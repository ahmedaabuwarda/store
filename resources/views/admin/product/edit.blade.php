<div class="col-xl-12 col-md-12">
  <div class="form-group">
    ...
    <div class="input-group">
      ...
      <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="اسم المنتج" value="{{ $product->name }}" autocomplete="name" required autofocus>
