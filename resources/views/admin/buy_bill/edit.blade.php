                  ...
                  <div class="col-xl-6 col-md-12">
                    ...
                    <div class="form-group mt--3">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="الداعمون" value="{{ $buy_bill->provider->name }}" disabled>
                    ...
                    <div class="form-group mt--3">
                      <label class="form-control-label">Customers | المستفيدون</label>
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <span class="input-group-text" id="basic-addon1"><i class="fa fa-box text-info"></i></span>
                        </div>
                        <input type="text" class="form-control" placeholder="Customers | المستفيدون" value="{{ $buy_bill->customer->name }}" disabled>
