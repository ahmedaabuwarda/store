      ...
      <div class="card">
        <div class="card-header border-0">
          <div class="row align-items-center">
            <div class="col">
              <h3 class="mb-0">تعديل عملة</h3>
            </div>
          </div>
        </div>
        <form action="{{ URL('/currency/update') }}" method="POST">
          @csrf
          <div class="col-12">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="اسم العملة" value="{{ $currency->name }}" autocomplete="name" required autofocus>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control @error('symbol') is-invalid @enderror" name="symbol" placeholder="رمز العملة" value="{{ $currency->symbol }}" autocomplete="symbol" required autofocus>
              </div>
              @error('symbol')
              <span class="text-danger">{{ $message }}</span>
              @enderror
