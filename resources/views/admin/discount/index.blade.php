...
<div class="container-fluid mt--8">
        ...
        <div class="card-header border-0">
          <div class="row align-items-center">
            ...
            <div class="col-xl-8 col-md-12 text-center">
              <input type="text" name="search_input" id="search_input" class="form-control" placeholder="...ابحث عن خصم او مصروف">
            </div>
            <div class="col-xl-3 col-md-12 text-right">
              <a href="{{ URL('/discount/to_excel') }}" class="btn btn-success disabled" data-toggle="tooltip" data-placement="top" title="تصدير excel"><i class="fas fa-file-excel fa-lg mr-1"></i></a>
              <button class="btn btn-danger" data-toggle="modal" data-target="#from_to_pdf_modal"><i class="fas fa-file-pdf fa-lg mr-1"></i></button>
              <a class="btn btn-dark text-white" data-toggle="modal" data-target="#create_discount_modal"><i class="fa fa-minus"></i> مصروف</a>
            </div>
          </div>
        </div>
  ...
  <nav aria-label="..." class="justify-content-center">
    <ul class="pagination justify-content-center">
      ...
      @for($p = 1; $p <= $pages; $p++)
      <li class="page-item @if(Request::fullUrl() == URL('/discounts?page=' . $p)) active @endif"><a class="page-link" href="{{ URL('/discounts?page=' . $p) }}">{{ $p }}</a></li>
      @endfor
      <li class="page-item">
...
<div class="modal fade" id="create_discount_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="form-group">
                <label class="form-control-label">المبلغ</label>
                  <div class="input-group">
                      ...
                      <input type="number" class="form-control @error('balance') is-invalid @enderror" name="balance" placeholder="المبلغ" value="{{ old('balance') }}" autocomplete="balance" required autofocus>
                  </div>
                  @error('balance')
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                <label class="form-control-label">ملاحظات</label>
                  <div class="input-group">
                      <textarea type="text" class="form-control @error('notes') is-invalid @enderror" name="notes" placeholder="ملاحظات" autocomplete="notes">{{ old('name') }}</textarea>
                  </div>
                  @error('notes')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
