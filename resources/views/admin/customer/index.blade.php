            ...
            <div class="col-12">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="اسم المستفيد" value="{{ old('name') }}" autocomplete="name" required autofocus>
                </div>
                @error('name')
    ...
    $.ajax({
      ...
      success: function(response) {
        if (response.status == "success") {
          ...
          Swal.fire(
            'عفواً',
            'حدث خطأ ما، قد يكون المستفيد موجوداً بالفعل',
            'error'
          );
        }
      },
