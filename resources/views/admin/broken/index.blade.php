    ...
    <div class="container-fluid mt--8">
            ...
            <div class="col-xl-12">
                <div class="card" id="broken_table_card">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-xl-2 col-md-12 text-md-center text-xl-left">
                                <h3 class="mb-0">فواتير البضاعة التالقة</h3>
                            </div>
                            ...
                            <div class="col-xl-3 col-md-12 text-xl-right text-md-center">
                                ...
                                <a href="{{ url('/broken/create') }}" class="btn btn-dark text-white" data-movement="create_broken">
                    ...
                    <div class="table-responsive">
                        <!-- Projects table -->
                        <table class="table tablee align-items-center table-flush table-hover" id="broken_table">
                            @include('admin.broken.table')
                        </table>
                    </div>
                </div>
            </div>
        ...
        <nav aria-label="..." class="justify-content-center">
            <ul class="pagination justify-content-center">
                ...
                @for ($p = 1; $p <= $pages; $p++)
                    <li class="page-item @if (Request::fullUrl() == URL('/brokens?page=' . $p)) active @endif"><a class="page-link"
                            href="{{ URL('/brokens?page=' . $p) }}">{{ $p }}</a></li>
                @endfor
                <li class="page-item">
