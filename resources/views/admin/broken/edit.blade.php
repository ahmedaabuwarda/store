...
@section('content')
        ...
        <div class="col-xl-9 col-md-9 m-auto">
          <div class="card card-stats">
            ...
            <div class="card-header">
              <div class="row">
                <div class="col">
                  ...
                  <span class="h2 font-weight-bold mb-0">تحديث</span>
                </div>
                <div class="col-auto">
            ...
            <div class="card-body bg-secondary">
              ...
              <form action="{{ URL('/broken/update/' . $broken_bill->id) }}" method="POST" id="broken_update_form">
                @csrf
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control datepicker"
                                placeholder="اختار التاريخ" type="text"
                                value="{{ $broken_bill->date_created }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control"
                                placeholder="رقم الفاتورة" value="{{ $broken_bill->number }}" disabled>
                        </div>
                    </div>
                ...
                <div class="row" id="productsCart">
                  ...
                  <table class="table table-hover" id="productTable">
                    ...
                    <tbody>
                    @php $i = 1; @endphp
                      @foreach($broken_bill->sold_product as $product)
                        <tr>
                    ...
                    <table class="table table-hover mb-2" id="productTableTotal">
                        <thead>
                            <th class="text-center">الاجمالي</th>
                            <th class="text-center" id="total">{{ $broken_bill->total_balance }}</th>
                            <th class="text-center" id="profit">0</th>
                        </thead>
                    </table>
                  ...
                  <div class="col-xl-6 col-md-12 mt-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="paid_balance"
                                ...
                                placeholder="المبلغ المدفوع" value="{{ $broken_bill->paid_balance }}" autocomplete="paid_balance"
                    ...
                    <div class="col-xl-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <textarea type="text" class="form-control @error('byan') is-invalid @enderror" name="byan" placeholder="البيان" autocomplete="byan" rows="2">{{ $broken_bill->byan }}</textarea>
                            </div>
                        </div>
                    </div>
  ...
  var i = 1;
  var total = {{ $broken_bill->total_balance }};
  var profit = 0;
