    ...
    @else
        ...
        @foreach ($movements as $movement)
            <tr>
                ...
                <td class="display-3 text-center">@if ($movement->type == 0) <i class="fa fa-minus text-danger mr-1"></i> @else <i class="fa fa-plus text-success mr-1"></i> @endif{{ $movement->balance }}<i
