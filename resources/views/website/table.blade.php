...
<tbody>
  ...
  <tr>
    ...
    <td class="display-3 text-center">{{ $product->original_price }}<i class="fas fa-shekel-sign ml-1"></i></td>
    ...
    <td class="display-3 text-center">{{ $product->original_price * $product->quantity }}<i class="fas fa-shekel-sign ml-1"></i></td>
