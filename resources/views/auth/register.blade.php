        ...
        <div class="header-body text-center mb-5">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Register a new account</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <small>Type in your credentials</small>
              </div>
              <form role="form" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Full Name" type="text" value="{{ old('name') }}" required autocomplete="name" autofocus>
                  </div>
                  @error('email')
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Password" type="password" value="{{ old('password') }}" required autocomplete="password">
                  </div>
                  @error('password')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" name="password_confirmation" placeholder="Confirm Password" type="password" value="{{ old('password_confirmation') }}" required autocomplete="new-password">
                  </div>
                </div>
          ...
          <div class="row mt-3 text-center">
            <div class="col-12">
              <a href="{{ URL('/login') }}" class="text-light"><small>Back To Login Page</small></a>
            </div>
          </div>
        </div>
      </div>
